window.MerchantDetailManagementPage = {
  ...
  renderModal() {
    return `<div class="modal" id="detail-template-modal" hidden><form class="modal-card" id="detail-template-form" novalidate><div class="modal-header"><h2 id="detail-template-modal-title">添加详情页模板</h2><button class="icon-close" id="close-detail-template-modal" type="button" title="关闭">×</button></div><div class="modal-body">
      ...
      <div class="form-row" id="detail-template-type-row"><label class="required">样式类型：</label><div class="form-control-area"><div class="radio-group"><label class="radio-option"><input type="radio" name="detail-template-type" value="电商详情页" />电商详情页</label><label class="radio-option"><input type="radio" name="detail-template-type" value="充值详情页" />充值详情页</label><label class="radio-option"><input type="radio" name="detail-template-type" value="卡券详情页" />卡券详情页</label><label class="radio-option"><input type="radio" name="detail-template-type" value="其他" />其他</label></div><div class="error-message">请选择样式类型</div></div></div>
