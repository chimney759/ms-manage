window.MerchantFormPage = {
  ...
  get targetingIdentities() { return window.ConfigurationSections.identities; },
  get audienceGroups() { return window.ConfigurationSections.audienceGroups; },
  createTargeting() {
    return window.ConfigurationSections.createTargeting();
  },
  createTestPlan() {
    return { ...window.ConfigurationSections.createTestPlan(), enabled: true };
  },
  ...
  normalizeTargeting(targeting = {}) {
    return window.ConfigurationSections.normalizeTargeting(targeting);
  },
  render({ recordId = null } = {}) {
    return `<section class="content merchant-form-page">
      ...
      <form class="merchant-form" id="merchant-form" novalidate>
        ...
        ${window.ConfigurationSections.renderMerchantTargeting()}
        ${window.ConfigurationSections.renderMerchantTestPlan()}
