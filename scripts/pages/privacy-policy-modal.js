...
window.ForceUpgradeModalPage = {
  ...
  adaptCopy(markup) {
    return markup
      .replaceAll('隐私政策更新弹窗', '强制升级弹窗')
      .replaceAll('隐私政策版本', '升级版本')
      .replaceAll('隐私政策有更新', 'App 有新版本可升级')
      .replaceAll('此隐私政策更新弹窗', '此强制升级弹窗')
      .replaceAll('《隐私政策》', '《升级说明》')
      .replaceAll('我已阅读并同意</button>', '去更新</button><button class="privacy-popup-exit" type="button">放弃更新</button>');
  },
  render() {
    return this.adaptCopy(window.PrivacyPolicyModalPage.render.call(this));
  },
  renderForm({ recordId = null } = {}) {
    return this.adaptCopy(window.PrivacyPolicyModalPage.renderForm.call(this, { recordId }));
  },
  bindForm({ navigate, recordId }) {
    return window.PrivacyPolicyModalPage.bindForm.call(this, { navigate, recordId });
  },
  bind({ navigate, recordId, isAdd, isEdit } = {}) {
    window.PrivacyPolicyModalPage.bind.call(this, {
      recordId,
      isAdd,
      isEdit,
      navigate: (view) => {
...
window.GuidedUpgradeModalPage = {
  ...
  adaptCopy(markup) {
    return markup
      .replaceAll('隐私政策更新弹窗', '引导升级弹窗')
      .replaceAll('隐私政策版本', '升级版本')
      .replaceAll('隐私政策有更新', 'App 有新版本可升级')
      .replaceAll('此隐私政策更新弹窗', '此引导升级弹窗')
      .replaceAll('《隐私政策》', '《升级说明》')
      .replaceAll('我已阅读并同意</button>', '去更新</button><button class="privacy-popup-exit" type="button">放弃更新</button>');
  },
  render() {
