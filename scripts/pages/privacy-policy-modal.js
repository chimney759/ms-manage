window.PrivacyPolicyModalPage = {
  ...
  render() {
    return `<section class="content privacy-policy-page"><div class="page-heading"><h1>隐私政策更新</h1><span class="heading-note">维护 App 隐私政策更新提醒配置</span></div><section class="panel">
  ...
  renderForm({ recordId = null } = {}) {
    ...
    return `<section class="content privacy-policy-form-page"><div class="page-heading"><div class="page-title-row"><button class="back-button" id="back-to-privacy-policy-list" type="button" title="返回隐私政策更新列表">‹</button><h1>${isEdit ? '编辑隐私政策更新' : '添加隐私政策更新'}</h1></div></div>
