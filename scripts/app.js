(function bootstrap() {
  ...
  const routes = [
    ...
    { match: (view) => view === 'tab-red-dot-management-add', page: 'TabRedDotManagementPage', breadcrumb: '添加底Tab营销提醒', section: '推广管理', isAdd: true, render: (page) => page.renderEditor({ recordId: null }) },
    { match: (view) => view.startsWith('tab-red-dot-management-edit:'), page: 'TabRedDotManagementPage', breadcrumb: '编辑营销红点配置', section: '推广管理', getRecordId: (view) => view.slice('tab-red-dot-management-edit:'.length), isEdit: true, render: (page, recordId) => page.renderEditor({ recordId }) },
    { match: (view) => view === 'tab-red-dot-management', page: 'TabRedDotManagementPage', breadcrumb: '底Tab-红点管理', section: '推广管理' },
